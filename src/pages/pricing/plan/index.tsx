    ...
    <div className="mt-56 lg:mt-20 flex items-center w-full max-w-[1280px] flex-col px-10">
      ...
      <div className="flex w-full mt-24 lg:mt-10 gap-16 lg:gap-8 flex-wrap">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center justify-center w-[134px] h-[50px] lg:h-8 lg:text-xs rounded-md bg-[#B7D8FF26] text-lg font-semibold text-white/80">
            详细文档
          </div>
          ...
          <div className="flex gap-5 lg:gap-2 flex-wrap ">
            <div className="flex items-center justify-center w-[170px] h-12 lg:h-8 lg:text-xs rounded-md bg-[#BECFDC] text-lg font-semibold text-[#03080C]">
              购买入口
            </div>

            <div className="flex items-center justify-center w-[290px] h-12 lg:h-8 lg:text-xs rounded-md bg-[#B7D8FF26] text-lg font-semibold text-white/80">
              通过 licence 续费文档教程
            </div>
          </div>
        </div>
